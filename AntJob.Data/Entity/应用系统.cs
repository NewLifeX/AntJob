...
public partial class App
{
    ...
    /// <param name="managerId">管理人。负责该应用的管理员</param>
    ...
    public static IList<App> Search(Int32 managerId, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
